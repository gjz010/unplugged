...
这12个变换都是真叠合，但还存在反射的非真叠合。如图所示，针对四面体的中心$O$进行反射，左上角的四面体1234被变换成左下角的四面体3412。左上角绕对称轴旋转120度后变换成右上角的四面体3124，这是一个真叠合。而其相应的非真叠合变换结果则是右下角的四面体2431。针对$A_4$中的每个变换，都存在一个对应的非真叠合变换，也有12个。
