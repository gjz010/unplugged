...
These 12 transformations are all proper congruences. Besides, there are also improper congruences. As shown in figure \ref{fig:S4}, By inversion in point $O$, the tetrahedron 1234 on the up-left transforms to the bottom-left 3412. While when rotation by $120\degree$ against the axis, the up-left tetrahedron transforms to the up-right 3124, this is a proper congruence. Its corresponding improper one gives the bottom-right tetrahedron 2431. For every transform in $A_4$, there is a corresponding improper orientation-reversing reflection. In total 12.

\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.4]{img/S4.png}
 %\captionsetup{labelformat=empty}
 \caption{Improper congrence}
 \label{fig:S4}
\end{figure}


All the 24 transformations of proper and improper congruences are corresponding to the elements in $S_4$.
